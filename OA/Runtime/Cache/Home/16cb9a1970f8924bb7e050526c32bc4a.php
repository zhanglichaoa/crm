     ...
     <body>
       <div class="list_box">
           <div class="header">
               ...
               <span class="two"><a href="<?php echo U('Home/Project/task_list');?>">【返回】</a></span>
           </div>
           <div class="bottom">
           <form action="/Company_crm/index.php/Home/Project/task_add"  method="post"  enctype="multipart/form-data" onsubmit="return checktask();">
